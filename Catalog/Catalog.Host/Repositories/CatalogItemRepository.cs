...
namespace Catalog.Host.Repositories
{
    public class CatalogItemRepository : ICatalogItemRepository
    {
        ...
        public async Task<GetData<CatalogItem>> GetByIdAsync(int id)
        {
            ...
            return new GetData<CatalogItem>() { Data = items };
        }

        public async Task<GetData<CatalogItem>> GetByBrandAsync(int brandId)
        {
            var items = await _dbContext.CatalogItems
                .Include(i => i.CatalogType)
                .Include(i => i.CatalogBrand)
        ...
        public async Task<GetData<CatalogItem>> GetByTypeAsync(int typeId)
        {
            var items = await _dbContext.CatalogItems
                .Include(i => i.CatalogBrand)
                .Include(i => i.CatalogType)
