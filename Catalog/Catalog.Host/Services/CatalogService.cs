...
namespace Catalog.Host.Services
{
    public class CatalogService : BaseDataService<ApplicationDbContext>, ICatalogService
    {
        ...
        public async Task<GetResponse<CatalogItemDto>> GetCatalogItemsByIdAsync(int id)
        {
            return await ExecuteSafeAsync(async () =>
            {
                ...
                return new GetResponse<CatalogItemDto>()
                {
                    Data = result.Data.Select(s => _mapper.Map<CatalogItemDto>(s)).ToList(),
                };
            });
        ...
        public async Task<GetResponse<CatalogItemDto>> GetCatalogItemsByBrandAsync(int brandId)
        {
            return await ExecuteSafeAsync(async () =>
            {
        ...
        public async Task<GetResponse<CatalogItemDto>> GetCatalogItemsByTypeAsync(int typeId)
        {
            return await ExecuteSafeAsync(async () =>
            {
        ...
        public async Task<GetResponse<CatalogBrandDto>> GetCatalogBrandsAsync()
        {
            return await ExecuteSafeAsync(async () =>
            {
                ...
                return new GetResponse<CatalogBrandDto>()
                {
        ...
        public async Task<GetResponse<CatalogTypeDto>> GetCatalogTypesAsync()
        {
            return await ExecuteSafeAsync(async () =>
            {
                ...
                return new GetResponse<CatalogTypeDto>()
                {
